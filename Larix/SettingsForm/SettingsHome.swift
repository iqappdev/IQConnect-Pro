...
"""
    ...
    override func viewDidLoad() {
        ...
        form +++ Section()
            ...
            <<< ButtonRow() { row in
                ...
                let actionYes = UIAlertAction(title: NSLocalizedString("OK", comment: ""), style: .default, handler: { (_) in
                    LarixSettings.sharedInstance.resetDefaults()
                    DispatchQueue.main.async {
                        Toast(text: "Settings were reset to default").show()
                    }
                })
        ...
        form +++ Section("About Larix Broadcaster")
            <<< ButtonRow() {
