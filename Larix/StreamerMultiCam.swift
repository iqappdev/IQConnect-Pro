...
class StreamerMultiCam: Streamer {
    ...
    private var multiCamMode: LarixSettings.MultiCamMode = .off
    ...
    class func isSupported() -> Bool {
        return LarixSettings.sharedInstance.multiCamMode != .off
    }
    ...
    override func setupVideoIn() throws {
        ...
        let cameraPos = LarixSettings.sharedInstance.cameraPosition
        multiCamMode = LarixSettings.sharedInstance.multiCamMode
        switch multiCamMode {
        case .pip:
    ...
    private func configureBackCameraIn() -> Bool {
        ...
        guard let backCamera = LarixSettings.sharedInstance.getDefaultBackCamera(probe: probeMultiCam) else {
    ...
    private func configureBackCameraOut() -> Bool {
        ...
        self.maxZoomFactor = format.videoMaxZoomFactor
